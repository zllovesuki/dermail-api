...
var self = module.exports = {
	...
	getArrayOfFromAddress: Promise.method(function(r, accountId, fromAddresses) {
		...
		if (typeof fromAddresses !== 'object') fromAddresses = [];
	...
	getArrayOfToAddress: Promise.method(function(r, accountId, toAddresses) {
		// Perspective is relative. "To" in the eyes of RX, "From" in the eyes of TX
		if (typeof toAddresses !== 'object') toAddresses = [];
